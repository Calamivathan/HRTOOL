...
# Directories
GAMEPATCH_DIR = "/data/data/com.termux/files/home/Tool/gamepatch"
UNPACKED_RAW_DAT = os.path.join(GAMEPATCH_DIR, "unpacked_RAW_DAT")
UNPACKED_ASS_DAT = os.path.join(GAMEPATCH_DIR, "unpacked_ASS_DAT")
EDITED_DEASS_DAT = os.path.join(GAMEPATCH_DIR, "Edited_DEASS_DAT")
REPACKED_PAK = os.path.join(GAMEPATCH_DIR, "repacked_pak")
SEARCHED_DAT = os.path.join(GAMEPATCH_DIR, "Searched_DAT")
EDITED_DAT = os.path.join(GAMEPATCH_DIR, "Edited_DAT")
COMPARED_DAT = os.path.join(GAMEPATCH_DIR, "Compared_DAT")
...
def mode_options():
    show_banner()
    print(f"{Colors.BLUE}PAK TOOL Options{Colors.NOCOLOR}")
    print()
    print(f"{Colors.GREEN}1. Unpack PAK{Colors.NOCOLOR}")
    print(f"{Colors.GREEN}2. Repack PAK{Colors.NOCOLOR}")
    ...
    if option == 1:
        print("You selected Unpack PAK.")
        script_path = "/data/data/com.termux/files/home/Tool/HRModster_EXES/HRModster_T9"  # Script for unpacking
        execute_script(script_path)
        mode_options()
    elif option == 2:
        print("You selected Repack PAK.")
        script_path = "/data/data/com.termux/files/home/Tool/HRModster_EXES/HRModster_T10"  # Script for repacking
        execute_script(script_path)
        mode_options()
    elif option == 3:
        print("You selected Multi Search.")
        script_path = "/data/data/com.termux/files/home/Tool/HRModster_EXES/HRModster_T11"  # Script for multi-search
        execute_script(script_path)
        mode_options()
    elif option == 4:
        ...
        script_path = "/data/data/com.termux/files/home/Tool/HRModster_EXES/HRModster_T12"  # Script for comparing files
        execute_script(script_path)
        mode_options()
    elif option == 6:

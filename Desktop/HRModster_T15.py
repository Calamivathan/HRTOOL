...
# Paths and constants
EDITED_DAT = "/data/data/com.termux/files/home/Tool/mappak/Edited_DAT"
EDITED_DEASS_DAT = "/data/data/com.termux/files/home/Tool/mappak/Edited_DEASS_DAT"
REPACKED_PAK = "/data/data/com.termux/files/home/Tool/mappak/repacked_pak"
ORIGINAL_PAK = "/data/data/com.termux/files/home/Tool/mappak/Original_pak"
...
csv_filepath = "/data/data/com.termux/files/home/Tool/mappak/unpacked_ASS_DAT/names.csv"
...
def list_and_select_file(folder_path):
    ...
    if not files:
        ...
        time.sleep(0.5)
        subprocess.run(['/data/data/com.termux/files/home/Tool/HRModster_EXES/HRModster_T13'], check=True)
...
def main():
    ...
    xor_decrypt_file(copied_file_path)
